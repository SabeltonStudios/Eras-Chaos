...
class selectNivelHistoria extends Phaser.Scene {
    ...
    create() {
        ...
        if (espanol) {
            this.spriteTituloMapas = this.add.sprite(gameConfig.scale.width / 2, gameConfig.scale.height / 7, 'niveles');
            this.spriteTutorial= this.add.sprite(gameConfig.scale.width / 2, gameConfig.scale.height *5/ 7, 'tutorialHistoria');
            var i;
            ...
            this.spriteTituloMapas = this.add.sprite(gameConfig.scale.width / 2, gameConfig.scale.height / 7, 'nivelesi');
            this.spriteTutorial= this.add.sprite(gameConfig.scale.width / 2, gameConfig.scale.height *5/ 7, 'tutorialHistoriai');
            var i;
        ...
        this.mapasButton[0] = this.add.sprite(gameConfig.scale.width / 6, gameConfig.scale.height / 3, mapas[0].sprite);
        this.mapasButton[0].setInteractive().on('pointerdown', () => this.scene.start("PrehistoriaScene"));

        this.mapasButton[1] = this.add.sprite((gameConfig.scale.width / 6) * 2, gameConfig.scale.height / 3, mapas[1].sprite);
        ...
        this.mapasButton[2] = this.add.sprite((gameConfig.scale.width / 6) * 3, gameConfig.scale.height / 3, mapas[2].sprite);
        ...
        this.mapasButton[3] = this.add.sprite((gameConfig.scale.width / 6) * 4, gameConfig.scale.height / 3, mapas[3].sprite);
        this.mapasButton[3].setInteractive().on('pointerdown', () => this.desbloquear(mapas[3 + mapasPosicion], dinero, 3));

        this.mapasButton[4] = this.add.sprite((gameConfig.scale.width / 6) * 5, gameConfig.scale.height / 3, mapas[4].sprite);
