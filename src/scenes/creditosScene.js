class creditosScene extends Phaser.Scene{
    ...
    create(){
        ...
        if(espanol){
            ...
            this.spriteDesarrolladores = this.add.sprite(gameConfig.scale.width*1.2/4,gameConfig.scale.height*1.7/3,'desarrolladores').setScale(0.9);
            this.spriteContacto = this.add.sprite(gameConfig.scale.width*2.8/4,gameConfig.scale.height*1.7/3,'contacto').setScale(0.9);
        }else{
            this.spriteTituloTienda = this.add.sprite(gameConfig.scale.width/2,gameConfig.scale.height/7,'tituloCreditosi');
            this.spriteDesarrolladores = this.add.sprite(gameConfig.scale.width*1.2/4,gameConfig.scale.height*1.7/3,'desarrolladoresi').setScale(0.9);
            this.spriteContacto = this.add.sprite(gameConfig.scale.width*2.8/4,gameConfig.scale.height*1.7/3,'contactoi').setScale(0.9);
        }

        this.spriteTwitter = this.add.sprite(gameConfig.scale.width*2.8/4,gameConfig.scale.height*5/12,'twitter').setScale(0.9);
        this.spriteTwitter.setInteractive().on('pointerdown', () => window.open('https://twitter.com/SabeltonStudios', '_blank'));

        this.spriteInstagram = this.add.sprite(gameConfig.scale.width*2.8/4,gameConfig.scale.height*6/12,'instagram').setScale(0.9);
        this.spriteInstagram.setInteractive().on('pointerdown', () => window.open('https://www.instagram.com/sabeltonstudios/', '_blank'));

        this.spriteYoutube = this.add.sprite(gameConfig.scale.width*2.8/4,gameConfig.scale.height*7/12,'youtube').setScale(0.9);
        this.spriteYoutube.setInteractive().on('pointerdown', () => window.open('https://youtube.com/channel/UCaw0EJIphiofJF5lcD1SEJg', '_blank'));

        this.spriteItchio = this.add.sprite(gameConfig.scale.width*2.8/4,gameConfig.scale.height*8/12,'itchio').setScale(0.9);
        this.spriteItchio.setInteractive().on('pointerdown', () => window.open('https://sabeltonstudios.itch.io/', '_blank'));

        this.spriteGithub = this.add.sprite(gameConfig.scale.width*2.8/4,gameConfig.scale.height*9/12,'github').setScale(0.9);
        this.spriteGithub.setInteractive().on('pointerdown', () => window.open('https://github.com/SabeltonStudios', '_blank'));

        this.spriteGmail = this.add.sprite(gameConfig.scale.width*2.8/4,gameConfig.scale.height*10/12,'gmail').setScale(0.9);
