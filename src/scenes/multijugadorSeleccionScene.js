...
class multijugadorSeleccionScene extends Phaser.Scene {
    ...
    create() {
        ...
        if (espanol) {
            this.spriteJugador1 = this.add.sprite((gameConfig.scale.width / 6) + 120, gameConfig.scale.height / 2.6, 'jugador1').setScale(0.4 * gameConfig.scale.height / 600);
            this.spriteJugador2 = this.add.sprite((gameConfig.scale.width *5 / 6) - 120, gameConfig.scale.height / 2.6, 'jugador2').setScale(0.4 * gameConfig.scale.height / 600);
        } else {
            this.spriteJugador1 = this.add.sprite((gameConfig.scale.width / 6) + 120, gameConfig.scale.height / 2.6, 'jugador1i').setScale(0.4 * gameConfig.scale.height / 600);
            this.spriteJugador2 = this.add.sprite((gameConfig.scale.width *5 / 6) - 120, gameConfig.scale.height / 2.6, 'jugador2i').setScale(0.4 * gameConfig.scale.height / 600);
        ...
        if (personajes[0].bloqueado) {
            this.personajesButton[0] = this.add.sprite(gameConfig.scale.width / 6, gameConfig.scale.height / 2, personajes[0].seleccionBloqueado).setScale(0.4 * gameConfig.scale.height / 600);
        } else {
            this.personajesButton[0] = this.add.sprite(gameConfig.scale.width / 6, gameConfig.scale.height / 2, personajes[0].seleccionDesbloqueado).setScale(0.4 * gameConfig.scale.height / 600);
        }
        ...
        if (personajes[1].bloqueado) {
            this.personajesButton[1] = this.add.sprite((gameConfig.scale.width / 6), gameConfig.scale.height / 1.55, personajes[1].seleccionBloqueado).setScale(0.4 * gameConfig.scale.height / 600);
        } else {
            this.personajesButton[1] = this.add.sprite((gameConfig.scale.width / 6), gameConfig.scale.height / 1.55, personajes[1].seleccionDesbloqueado).setScale(0.4 * gameConfig.scale.height / 600);
        }
        ...
        if (personajes[2].bloqueado) {
            this.personajesButton[2] = this.add.sprite((gameConfig.scale.width / 6) + 120, gameConfig.scale.height / 2, personajes[2].seleccionBloqueado).setScale(0.4 * gameConfig.scale.height / 600);
        } else {
            this.personajesButton[2] = this.add.sprite((gameConfig.scale.width / 6) + 120, gameConfig.scale.height / 2, personajes[2].seleccionDesbloqueado).setScale(0.4 * gameConfig.scale.height / 600);
        }
        ...
        if (personajes[3].bloqueado) {
            this.personajesButton[3] = this.add.sprite((gameConfig.scale.width / 6) + 120, gameConfig.scale.height / 1.55, personajes[3].seleccionBloqueado).setScale(0.4 * gameConfig.scale.height / 600);
        } else {
            this.personajesButton[3] = this.add.sprite((gameConfig.scale.width / 6) + 120, gameConfig.scale.height / 1.55, personajes[3].seleccionDesbloqueado).setScale(0.4 * gameConfig.scale.height / 600);
        }
        ...
        if (personajes[4].bloqueado) {
            this.personajesButton[4] = this.add.sprite((gameConfig.scale.width / 6) + 240, gameConfig.scale.height / 2, personajes[4].seleccionBloqueado).setScale(0.4 * gameConfig.scale.height / 600);
        } else {
            this.personajesButton[4] = this.add.sprite((gameConfig.scale.width / 6) + 240, gameConfig.scale.height / 2, personajes[4].seleccionDesbloqueado).setScale(0.4 * gameConfig.scale.height / 600);
        }
        ...
        if (personajes[5].bloqueado) {
            this.personajesButton[5] = this.add.sprite((gameConfig.scale.width / 6) + 240, gameConfig.scale.height / 1.55, personajes[5].seleccionBloqueado).setScale(0.4 * gameConfig.scale.height / 600);
        } else {
            this.personajesButton[5] = this.add.sprite((gameConfig.scale.width / 6) + 240, gameConfig.scale.height / 1.55, personajes[5].seleccionDesbloqueado).setScale(0.4 * gameConfig.scale.height / 600);
        }
        ...
        //Flechas derecha e izquierda
        this.spriteIzquierda = this.add.sprite((gameConfig.scale.width / 6) - 100, gameConfig.scale.height * 7 / 12, 'flechaIzquierda').setScale(0.2 * gameConfig.scale.height / 600);
        this.spriteIzquierda.setInteractive().on('pointerdown', () => this.trasladarIzquierda(1));

        this.spriteDerecha = this.add.sprite((gameConfig.scale.width / 6) + 340, gameConfig.scale.height * 7 / 12, 'flechaDerecha').setScale(0.2 * gameConfig.scale.height / 600);
        this.spriteDerecha.setInteractive().on('pointerdown', () => this.trasladarDerecha(1));

        //personajes 2
        if (personajes[0].bloqueado) {
            this.personajes2Button[0] = this.add.sprite(gameConfig.scale.width * 5 / 6 - 240, gameConfig.scale.height / 2, personajes[0].seleccionBloqueado).setScale(0.4 * gameConfig.scale.height / 600);
        } else {
            this.personajes2Button[0] = this.add.sprite(gameConfig.scale.width * 5 / 6 - 240, gameConfig.scale.height / 2, personajes[0].seleccionDesbloqueado).setScale(0.4 * gameConfig.scale.height / 600);
        }
        ...
        if (personajes[1].bloqueado) {
            this.personajes2Button[1] = this.add.sprite((gameConfig.scale.width * 5 / 6) - 240, gameConfig.scale.height / 1.55, personajes[1].seleccionBloqueado).setScale(0.4 * gameConfig.scale.height / 600);
        } else {
            this.personajes2Button[1] = this.add.sprite((gameConfig.scale.width * 5 / 6) - 240, gameConfig.scale.height / 1.55, personajes[1].seleccionDesbloqueado).setScale(0.4 * gameConfig.scale.height / 600);
        }
        ...
        if (personajes[2].bloqueado) {
            this.personajes2Button[2] = this.add.sprite((gameConfig.scale.width * 5 / 6) - 120, gameConfig.scale.height / 2, personajes[2].seleccionBloqueado).setScale(0.4 * gameConfig.scale.height / 600);
        } else {
            this.personajes2Button[2] = this.add.sprite((gameConfig.scale.width * 5 / 6) - 120, gameConfig.scale.height / 2, personajes[2].seleccionDesbloqueado).setScale(0.4 * gameConfig.scale.height / 600);
        }
        ...
        if (personajes[3].bloqueado) {
            this.personajes2Button[3] = this.add.sprite((gameConfig.scale.width * 5 / 6) - 120, gameConfig.scale.height / 1.55, personajes[3].seleccionBloqueado).setScale(0.4 * gameConfig.scale.height / 600);
        } else {
            this.personajes2Button[3] = this.add.sprite((gameConfig.scale.width * 5 / 6) - 120, gameConfig.scale.height / 1.55, personajes[3].seleccionDesbloqueado).setScale(0.4 * gameConfig.scale.height / 600);
        }
        ...
        if (personajes[4].bloqueado) {
            this.personajes2Button[4] = this.add.sprite((gameConfig.scale.width * 5 / 6), gameConfig.scale.height / 2, personajes[4].seleccionBloqueado).setScale(0.4 * gameConfig.scale.height / 600);
        } else {
            this.personajes2Button[2] = this.add.sprite((gameConfig.scale.width * 5 / 6), gameConfig.scale.height / 2, personajes[4].seleccionDesbloqueado).setScale(0.4 * gameConfig.scale.height / 600);
        }
        ...
        if (personajes[5].bloqueado) {
            this.personajes2Button[5] = this.add.sprite((gameConfig.scale.width * 5 / 6), gameConfig.scale.height / 1.55, personajes[5].seleccionBloqueado).setScale(0.4 * gameConfig.scale.height / 600);
        } else {
            this.personajes2Button[5] = this.add.sprite((gameConfig.scale.width * 5 / 6), gameConfig.scale.height / 1.55, personajes[5].seleccionDesbloqueado).setScale(0.4 * gameConfig.scale.height / 600);
        }
        ...
        //Flechas derecha e izquierda
        this.spriteIzquierda2 = this.add.sprite((gameConfig.scale.width * 5 / 6) - 340, gameConfig.scale.height * 7 / 12, 'flechaIzquierda').setScale(0.2 * gameConfig.scale.height / 600);
        this.spriteIzquierda2.setInteractive().on('pointerdown', () => this.trasladarIzquierda(2));

        this.spriteDerecha2 = this.add.sprite((gameConfig.scale.width * 5 / 6) + 100, gameConfig.scale.height * 7 / 12, 'flechaDerecha').setScale(0.2 * gameConfig.scale.height / 600);
        this.spriteDerecha2.setInteractive().on('pointerdown', () => this.trasladarDerecha(2));

        //Armas personaje 1
        if (armas[0].bloqueado) {
            this.armasButton[0] = this.add.sprite(gameConfig.scale.width /6, gameConfig.scale.height *4.7/ 6, armas[0].seleccionBloqueado).setScale(gameConfig.scale.height / 600);
        } else {
            this.armasButton[0] = this.add.sprite(gameConfig.scale.width /6, gameConfig.scale.height *4.7/ 6, armas[0].seleccionDesbloqueado).setScale(gameConfig.scale.height / 600);
        }
        ...
        if (armas[1].bloqueado) {
            this.armasButton[1] = this.add.sprite(gameConfig.scale.width /6+120, gameConfig.scale.height *4.7/ 6, armas[1].seleccionBloqueado).setScale(gameConfig.scale.height / 600);
        } else {
            this.armasButton[1] = this.add.sprite(gameConfig.scale.width /6+120, gameConfig.scale.height *4.7/ 6, armas[1].seleccionDesbloqueado).setScale(gameConfig.scale.height / 600);
        }
        ...
        if (armas[2].bloqueado) {
            this.armasButton[2] = this.add.sprite(gameConfig.scale.width /6+240, gameConfig.scale.height *4.7/ 6, armas[2].seleccionBloqueado).setScale(gameConfig.scale.height / 600);
        } else {
            this.armasButton[2] = this.add.sprite(gameConfig.scale.width /6+240, gameConfig.scale.height *4.7/ 6, armas[2].seleccionDesbloqueado).setScale(gameConfig.scale.height / 600);
        }
        ...
        //Flechas derecha e izquierda
        this.spriteIzquierdaArmas = this.add.sprite(gameConfig.scale.width /6 -100, gameConfig.scale.height *4.7/ 6, 'flechaIzquierda').setScale(0.2 * gameConfig.scale.height / 600);
        this.spriteIzquierdaArmas.setInteractive().on('pointerdown', () => this.trasladarIzquierda(3));

        this.spriteDerechaArmas = this.add.sprite(gameConfig.scale.width /6+ 340, gameConfig.scale.height *4.7/ 6, 'flechaDerecha').setScale(0.2 * gameConfig.scale.height / 600);
        this.spriteDerechaArmas.setInteractive().on('pointerdown', () => this.trasladarDerecha(3));

        //Armas personaje 2
        this.armas2Button[0] = this.add.sprite(gameConfig.scale.width *5 / 6 -240, gameConfig.scale.height *4.7/ 6, armas[0].seleccionDesbloqueado).setScale(gameConfig.scale.height / 600);
        ...
        if (armas[1].bloqueado) {
            this.armas2Button[1] = this.add.sprite(gameConfig.scale.width *5 / 6-120, gameConfig.scale.height *4.7/ 6, armas[1].seleccionBloqueado).setScale(gameConfig.scale.height / 600);
        } else {
            this.armas2Button[1] = this.add.sprite(gameConfig.scale.width *5 / 6-120, gameConfig.scale.height *4.7/ 6, armas[1].seleccionDesbloqueado).setScale(gameConfig.scale.height / 600);
        }
        ...
        if (armas[2].bloqueado) {
            this.armas2Button[2] = this.add.sprite(gameConfig.scale.width *5 / 6, gameConfig.scale.height *4.7/ 6, armas[2].seleccionBloqueado).setScale(gameConfig.scale.height / 600);
        } else {
            this.armas2Button[2] = this.add.sprite(gameConfig.scale.width *5 / 6, gameConfig.scale.height *4.7/ 6, armas[2].seleccionDesbloqueado).setScale(gameConfig.scale.height / 600);
        }
        ...
        //Flechas derecha e izquierda
        this.spriteIzquierdaArmas2 = this.add.sprite(gameConfig.scale.width *5 / 6-340, gameConfig.scale.height *4.7/ 6, 'flechaIzquierda').setScale(0.2 * gameConfig.scale.height / 600);
        this.spriteIzquierdaArmas2.setInteractive().on('pointerdown', () => this.trasladarIzquierda(4));

        this.spriteDerechaArmas2 = this.add.sprite(gameConfig.scale.width *5 / 6+100, gameConfig.scale.height *4.7/ 6, 'flechaDerecha').setScale(0.2 * gameConfig.scale.height / 600);
    ...
    mostrarMensajeBloqueado(){
        ...
        this.spriteDerechaArmas.disableInteractive();
        this.spriteDerechaArmas2.disableInteractive();
        this.spriteDerechaMapa.disableInteractive();
        this.tienda.setInteractive().on('pointerdown', () => this.scene.start("TiendaScene"));
        this.botonCerrar = this.add.sprite(this.mensaje.width*1.3, this.mensaje.height*1.27, 'CloseB').setScale(0.07*gameConfig.scale.height / 600);
    ...
    cerrarMensajeTienda(){
        ...
        this.spriteDerechaArmas.setInteractive();
        this.spriteDerechaArmas2.setInteractive();
        this.spriteDerechaMapa.setInteractive();
